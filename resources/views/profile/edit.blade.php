...
@section('content')
    @include('users.partials.header', [
        ...
        'description' => __('ESTA É A SUA PÁGINA DE PERFIL. VOCÊ PODE TROCAR SUA SENHA SEU NOME E SUA FOTO'),
        'class' => 'col-lg-7'
    ])   
                    ...
                    <div class="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
                        <div class="d-flex justify-content-between">
                            <div class="custom-file">
                                <label class="btn btn-sm btn-default float-left" for="customFileLang">Escolher Foto</label>
                                <form action="{{ route('fotoPerfil') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <input type="file" hidden id="customFileLang" name="fotoPerfil">
                    ...
                    <div class="card-body pt-0 pt-md-4">
                        ...
                        <div class="text-center">
                            ...
                            <div class="h5 font-weight-300">
                                <i class="ni location_pin mr-2"></i>{{ auth()->user()->cpf }}
                            </div>
                            <div class="h5 mt-4">
                                <i class="ni business_briefcase-24 mr-2"></i>Cargo Atual:
                            </div>
                            <div>
                        ...
                        <form method="post" action="{{ route('profile.update') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-email">{{ __('Login') }}</label>
